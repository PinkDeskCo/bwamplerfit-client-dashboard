    ...
    ================================================== */
        function updateStatistics() {
            ...
            const totalSessions =
                Object.values(activityEntries)
                    .reduce(function (total, entry) {
                        ...
                        return total + entry.sessions.length;
                    }, 0);
            ...
            const totalMiles =
                Object.values(activityEntries)
                    .reduce(function (total, entry) {
                        ...
                        return total + entryMiles;
                    }, 0);

            const summaryTotalSessions =
                document.querySelector(
            ...
            if (summaryTotalSessions) {
                summaryTotalSessions.textContent =
                    totalSessions.toLocaleString();
            }

            const summaryTotalMinutes =
                document.querySelector(
                    '#summary-total-minutes'
                );

            if (summaryTotalMinutes) {
                summaryTotalMinutes.textContent =
                    totalActivityMinutes.toLocaleString();
            }

            const summaryTotalSteps =
                document.querySelector(
                    '#summary-total-steps'
                );

            if (summaryTotalSteps) {
                summaryTotalSteps.textContent =
                    totalSteps.toLocaleString();
            }

            const summaryTotalMiles =
                document.querySelector(
                    '#summary-total-miles'
                );

            if (summaryTotalMiles) {
                summaryTotalMiles.textContent =
